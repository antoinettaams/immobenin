      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          <motion.div 
            ...
            className="inline-block px-4 py-1.5 mb-4 lg:mb-6 text-sm font-bold text-brand bg-brand/10 rounded-full"
            role="status"
          ...
          <h1 
            id="hero-title"
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-gray-900 leading-[1.1] mb-4 lg:mb-6"
          >
            Louez ou proposez <br className="hidden sm:block" />
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-6 lg:mb-8 max-w-lg leading-relaxed">
            Maisons, appartements meublés, bureaux, salles d&apos;événements ou terrains. 
            Trouvez l&apos;endroit idéal ou rentabilisez le vôtre.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 w-full justify-center lg:justify-start">
            <Button 
              size="lg" 
      ...
      <div className="lg:hidden mt-12">
        <div className="relative w-full max-w-md mx-auto">
          <Image
            ...
            alt="Location d'espaces au Bénin"
            width={600}
            height={400}
          ...
          <div 
            ...
            aria-label="Statistiques ImmoBenin"
          >
            <div className="text-center">
              <p className="text-2xl font-bold text-brand">500+</p>
              <p className="text-xs text-gray-600">Espaces disponibles</p>
            </div>
          </div>
        </div>
      </div>
