...
// Solution compatible Next.js 16.1.1
export async function GET(
  request: NextRequest,
  context: { params: { id: string } }  // params est un objet, pas une Promise
) {
  try {
    // Extraire l'ID depuis params
...
// Méthodes OPTIONALES (si vous en avez besoin)
